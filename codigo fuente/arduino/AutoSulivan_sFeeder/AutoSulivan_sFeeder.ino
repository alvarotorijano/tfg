 ...
 */
   ...
   * @param second     [Segundo. De 0 a 59]
   * @param minute     [Minuto. De 0 a 59]
   * @param hour       [Hora en formato 24 horas]
   * @param dayOfWeek  [dia de la semana de 1 a 7, siendo 1 el domingo, a pesar de que esta interpretacion es arbitraria]
   * @param dayOfMonth [Dia del mes. De 1 a 31 en los meses que sea posible]
   * @param month      [Mes del año. De 1 a 12]
   * @param year       [Año. De 0 a 99 siendo este el numero que se suma al año 2000]
   */
   ...
   * @param dayOfWeek  [Dia de la semana actual. De 1 a 7, siendo 1 el domingo, a pesar de que esta interpretacion es arbitraria]
   * @param dayOfMonth [Dia del mes actual]
 ...
 * @param  entrada  [Caena de texto a evaluar]
 * @param  opciones [Puntero a un array de cadenas para comparar]
 * @param  longitud [Puntero a un array con la longitud de cada cadena a comparar]
 * @param  cant     [Numero de elementos en los arrays de cadenas]
 * @param  p        [Numero de caracteres desechados ]
 * @return          [Posicion en el vector mas uno de la cadena encontrada]
 */
  byte comparaOpcion(char * entrada, String * opciones, byte * longitud, byte cant, byte * p)

  /**
   * [Gira la tolva]
   * @param vueltas [Numero de vueltas que tiene que girar la tolvaº]
   * @param sentido [Sentido horario true y antihorario false]
   */
